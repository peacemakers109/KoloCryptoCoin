 ...
 * between kolocryptocoind, and kolocryptocoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("kolocryptocoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/peacemakers109/KoloCryptoCoin>";
    const std::string URL_WEBSITE = "<http://projectkolo.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The KoloCryptoCoin Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find KoloCryptoCoin useful. "
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("kolocryptocoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("KoloCryptoCoin More version %s\n", FormatFullVersion());
}
