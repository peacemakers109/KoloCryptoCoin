...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"kolocryptocoinaddress\"\n"
            "\nReveals the private key corresponding to 'kolocryptocoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"kolocryptocoinaddress\"   (string, required) The kolocryptocoin address for the private key\n"
            "\nResult:\n"
