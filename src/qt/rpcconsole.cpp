                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNWCPathCustom = GetArg("-znwcbackuppath", "");
    ...
    if(!strzNWCPathCustom.empty()) {
        ui->wallet_customznwcbackuppath->setText(QString::fromStdString(strzNWCPathCustom));
        ui->wallet_customznwcbackuppath_label->setVisible(true);
        ui->wallet_customznwcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNWCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NWCCurrency RPC console.") + "<br>" +
