...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NWC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNWCCurrencyAmount"))
        SoftSetArg("-anonymizenwccurrencyamount", settings.value("nAnonymizeNWCCurrencyAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in nwccurrency.cpp during shotdown to also remove the window positions
