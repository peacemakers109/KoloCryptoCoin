    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextKoloCryptoCoin   = QChar(0xA9)+QString(" %1 ").arg(2024) + QString("The KoloCryptoCoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextKoloCryptoCoin);
    }
