...
/* NWCCurrency GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NWCCurrency"
#define QAPP_ORG_DOMAIN "nwccurrency.org"
#define QAPP_APP_NAME_DEFAULT "NWCCurrency-Qt"
#define QAPP_APP_NAME_TESTNET "NWCCurrency-Qt-testnet"
