...
const QString BITCOIN_IPC_PREFIX("kolocryptocoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/kolocryptocoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/kolocryptocoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/kolocryptocoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click kolocryptocoin: links
...
//
// OSX-specific way of handling kolocryptocoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in kolocryptocoin: URIs
