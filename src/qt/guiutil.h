...
/** Utility functions used by the NWCCurrency Qt UI.
 */
namespace GUIUtil
{
...
// Render NWCCurrency addresses in monospace font
...
// Parse "nwccurrency:" URI into recipient object, return true on successful parsing
