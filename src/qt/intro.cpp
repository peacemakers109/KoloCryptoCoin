...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NWCCurrency Core"),
     ...
     * override -datadir in the nwccurrency.conf file in the default data directory
     * (to be consistent with nwccurrencyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
