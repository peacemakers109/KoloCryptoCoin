...
#ifndef NWCCurrency_ZNWCWALLET_H
#define NWCCurrency_ZNWCWALLET_H
...
public:
    CzNWCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNWC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNWC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //NWCCurrency_ZNWCWALLET_H
