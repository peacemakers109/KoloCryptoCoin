...
#ifndef NWCCurrency_ZNWCTRACKER_H
#define NWCCurrency_ZNWCTRACKER_H
...
public:
    CzNWCTracker(std::string strWalletFile);
    ~CzNWCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNWCWallet* zNWCWallet = NULL);
...
#endif //NWCCurrency_ZNWCTRACKER_H
