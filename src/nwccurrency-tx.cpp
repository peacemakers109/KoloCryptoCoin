...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NWCCurrency Core nwccurrency-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nwccurrency-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nwccurrency transaction") + "\n" +
                               "  nwccurrency-tx [options] -create [commands]   " + _("Create hex-encoded nwccurrency transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nwccurrency transaction
