...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kolocryptocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kolocryptocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kolocryptocoin transaction") + "\n" +
              "  kolocryptocoin-tx [options] -create [commands]   " + _("Create hex-encoded kolocryptocoin transaction") + "\n" +
              "\n";
