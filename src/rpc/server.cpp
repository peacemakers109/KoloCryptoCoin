...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NWCCurrency server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "NWCCurrency server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NWCCurrency features */
        {"nwccurrency", "listmasternodes", &listmasternodes, true, true, false},
        {"nwccurrency", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nwccurrency", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nwccurrency", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nwccurrency", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nwccurrency", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nwccurrency", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nwccurrency", "masternodedebug", &masternodedebug, true, true, false},
        {"nwccurrency", "startmasternode", &startmasternode, true, true, false},
        {"nwccurrency", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nwccurrency", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nwccurrency", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nwccurrency", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nwccurrency", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nwccurrency", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nwccurrency", "preparebudget", &preparebudget, true, true, false},
        {"nwccurrency", "submitbudget", &submitbudget, true, true, false},
        {"nwccurrency", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nwccurrency", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nwccurrency", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nwccurrency", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nwccurrency", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nwccurrency", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nwccurrency", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nwccurrency", "checkbudgets", &checkbudgets, true, true, false},
        {"nwccurrency", "mnsync", &mnsync, true, true, false},
        {"nwccurrency", "spork", &spork, true, true, false},
        {"nwccurrency", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getznwcseed", &getznwcseed, false, false, true},
        {"zerocoin", "setznwcseed", &setznwcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdznwc", &searchdznwc, false, false, true},
        {"zerocoin", "dznwcstate", &dznwcstate, false, false, true},
...
{
    return "> nwccurrency-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16425/\n";
}
