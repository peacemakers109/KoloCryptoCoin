...
Add these lines to your `/etc/tor/torrc` (or equivalent config file):
    ...
    HiddenServicePort 16384 127.0.0.1:16383

The directory can be different of course, but virtual port numbers should be equal to
your bitcoind's P2P listen port (16384 by default), and target addresses and ports
should be equal to binding address and port for inbound Tor connections (127.0.0.1:16383 by default).
...
and open port 16384 on your firewall (or use port mapping, i.e., `-upnp`).
