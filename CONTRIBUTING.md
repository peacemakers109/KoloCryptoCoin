Contributing to NWCCurrency Core
============================

The NWCCurrency Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nwccurrency-project/nwccurrency/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NWCCurrency Core project, and is not to be
confused with overall NWCCurrency Network Protocol consensus changes.

Whether a pull request is merged into NWCCurrency Core rests with the project merge
...
Patches that change NWCCurrency consensus rules are considerably more involved than
...
Where a patchset proposes to change the NWCCurrency consensus, it must have been
...
The project leader is the release manager for each NWCCurrency Core release.
