...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/nwccurrency-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nwccurrency-cli.cpp \
           src/nwccurrency-tx.cpp \
           src/nwccurrency.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/nwccurrency.qrc src/qt/nwccurrency_locale.qrc

TRANSLATIONS += src/qt/locale/nwccurrency_bg.ts \
                src/qt/locale/nwccurrency_de.ts \
                src/qt/locale/nwccurrency_en.ts \
                src/qt/locale/nwccurrency_es.ts \
                src/qt/locale/nwccurrency_fi.ts \
                src/qt/locale/nwccurrency_fr.ts \
                src/qt/locale/nwccurrency_it.ts \
                src/qt/locale/nwccurrency_ja.ts \
                src/qt/locale/nwccurrency_pl.ts \
                src/qt/locale/nwccurrency_pt.ts \
                src/qt/locale/nwccurrency_ru.ts \
                src/qt/locale/nwccurrency_sk.ts \
                src/qt/locale/nwccurrency_sv.ts \
                src/qt/locale/nwccurrency_vi.ts \
                src/qt/locale/nwccurrency_zh_CN.ts \
                src/qt/locale/nwccurrency_zh_TW.ts
