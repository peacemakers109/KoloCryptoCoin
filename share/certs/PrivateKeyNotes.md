...
unlocked to sign the KoloCryptoCoin-Qt.app bundle.
...
allowing somebody to distribute a KoloCryptoCoin-Qt.app or kolocryptocoin-qt-setup.exe with a valid
...
that the kolocryptocoin-qt.exe file inside the installer had not been tampered with.
