...
from fake_stake.base_test import NWCCurrency_FakeStakeTest

class zNWCwrappedSerialsTest(NWCCurrency_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zNWCs..." % DENOM_TO_USE)
